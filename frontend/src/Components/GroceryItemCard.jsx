  ...
  return (
    <div className="bg-white m-2 lg:p-4 p-2 flex-row  ">
      ...
      <div className="p-2 flex-row  justify-center">
        <p className="text-xs flex justify-center font-semibold h-5">{item.name}</p>

        <div className="flex gap-4 max-sm:gap-2 justify-center  items-center">
          <h3 className="font-semibold py-2 max-sm:text-[13px] md:text-md sm:text-sm ">₹{item.price}</h3>
